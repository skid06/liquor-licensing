      ...
      <div>
        ...
        >
          <template v-slot:items="props">
            ...
            <td class="text-xs-left">{{ props.item.notes[props.item.notes.length - 1].message }} - <span style="font-size:8px">{{ props.item.notes[props.item.notes.length - 1].created_at | moment("h:mm:ss a | MMMM Do YYYY") }}</span></td>
