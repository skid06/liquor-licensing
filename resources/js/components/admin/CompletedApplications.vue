            ...
            <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                ...
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                        ...
                        <tbody>
                            <tr class="gradeX odd" role="row" v-for="application in applications" :key="application.id">
                                <!-- <td>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                ...
                                <td class="sorting_1"> <a :href="application.id"> {{ application.corporate_name }} </a> </td>
                                <td>
                                    <a href="mailto:userwow@gmail.com"> {{ application.business_email }} </a>
                                </td>
                                <td>
                                    <span class="label label-sm label-info"> Info </span>
                                </td>
                                <td class="center"> {{ application.created_at }} </td>
                                <td>
                                    <div class="btn-group">
