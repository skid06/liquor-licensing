        ...
        <div class="portlet light ">
          <div class="portlet-title">
            <div class="caption font-dark">
              ...
              <span class="caption-subject bold uppercase"> Paid Applications </span>
            </div>
            <div class="actions">
            ...
            <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="dataTables_length" id="sample_1_length"><label>Show <select name="sample_1_length" aria-controls="sample_1" class="form-control input-sm input-xsmall input-inline">
                ...
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                        ...
                        <tbody>
                            <tr class="gradeX odd" role="row" v-for="paid in applications.data" :key="paid.id">
                                <!-- <td>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                ...
                                <td class="sorting_1"> <a :href="paid.id"> {{ paid.corporate_name }} </a> </td>
                                <td>
                                    <a href="mailto:userwow@gmail.com"> {{ paid.business_email }} </a>
                                </td>
                                <td>
                                    <span class="label label-sm label-info"> Info </span>
                                </td>
                                <td class="center"> {{ paid.created_at }} </td>
                                <td>
                                    <div class="btn-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li v-bind:class="[{disabled: !applications.prev_page_url}]" class="page-item"><a class="page-link" href="#" @click="getApplications(applications.prev_page_url)">Previous</a></li>
                                ...
                                <li v-bind:class="[{disabled: !applications.next_page_url}]" class="page-item"><a class="page-link" href="#" @click="getApplications(applications.next_page_url)">Next</a></li>
                            </ul>
                        </nav>                         
                    </div>
                </div>
