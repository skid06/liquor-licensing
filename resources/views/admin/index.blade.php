          ...
          <div class="portlet-body">
              <div class="tabbable-line">
                  <ul class="nav nav-tabs">
                      <li class="">
                          <a href="#overview_1" data-toggle="tab" aria-expanded="false"> Top Selling </a>
                      </li>
                      <li class="active">
                          <a href="#overview_2" data-toggle="tab" aria-expanded="true"> Most Viewed </a>
                      </li>
                      <li>
                          <a href="#overview_3" data-toggle="tab"> New Customers </a>
                      </li>
                      <li class="dropdown">
                          <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> Orders
                              <i class="fa fa-angle-down"></i>
                          </a>
                          <ul class="dropdown-menu pull-right">
                              <li>
